 ...
 * @since 3.0
 */
public class ActivityMvixDelegateImpl<V extends MvpView, P extends MviPresenter<V, ?>>
        implements ActivityMviDelegate {


    public static boolean DEBUG = false;
    private static final String DEBUG_TAG = "ActivityMvixDelegateImpl";
     ...
     */
    public ActivityMvixDelegateImpl(@NonNull Activity activity,
