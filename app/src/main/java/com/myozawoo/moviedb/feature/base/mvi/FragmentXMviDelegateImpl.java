 ...
 * @since 3.0.0
 */
public class FragmentXMviDelegateImpl<V extends MvpView, P extends MviPresenter<V, ?>>
        implements FragmentMviDelegate<V, P> {

    public static boolean DEBUG = false;
    private static final String DEBUG_TAG = "FragmentXMviDelegateImpl";
    ...
    public FragmentXMviDelegateImpl(@NonNull MviDelegateCallback<V, P> delegateCallback,
    ...
    private boolean retainPresenterInstance(boolean keepPresenterOnBackstack, Activity activity,
        ...
        if (keepPresenterOnBackstack && BackstackReader.isInBackStackAndroidX(fragment)) {
            return true;
        }
