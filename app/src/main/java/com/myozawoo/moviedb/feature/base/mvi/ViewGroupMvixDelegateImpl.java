package com.myozawoo.moviedb.feature.base.mvi;
...
import com.hannesdorfmann.mosby3.*;
 ...
 * @since 3.0.0
 */
public class ViewGroupMvixDelegateImpl<V extends MvpView, P extends MviPresenter<V, ?>>
    ...
    public ViewGroupMvixDelegateImpl(@NonNull View view,
    ...
    @Override public void onDetachedFromWindow() {
        ...
        if (!checkedActivityFinishing) {
            ...
            boolean destroyPermanently = !ActivityMvixDelegateImpl.retainPresenterInstance(
    ...
    @Override public void onActivityDestroyed(Activity activity) {
        if (activity == this.activity) {
            ...
            boolean destroyedPermanently = !ActivityMvixDelegateImpl.retainPresenterInstance(
                    keepPresenterDuringScreenOrientationChange, activity);
    ...
    private void destroyPresenterIfnotDoneYet() {
        if (!presenterDestroeyed && presenter != null) {
            presenter.destroy();
    ...
    private void detachPresenterIfNotDoneYet() {
        if (!presenterDetached && presenter != null) {
